  ...
  $.fn.swipeslider = function (options) {
    ...
    */
    (function init() {
      ...
      slider.find('.sw-slide:nth-child(2)').addClass("active");
    ...
    */
    function swipeStart(event) {
      ...
      slider.find(".sw-slide").removeClass("active");
      disableAutoPlay();
    ...
    */
    function swipeEnd(event) {
      if (slidingState == 2) {
        ...
        slider.find('.sw-slide:nth-of-type('+ (currentSlide + 1) +')').addClass("active");
      }
    ...
    */
    function switchSlide() {
      ...
      var $s = slider.find('.sw-slide').removeClass("active");
      var a = 2;
      if(currentSlide == $s.length -1) {
        slider.find('.sw-slide:nth-of-type('+ 2 +')').addClass("active");
      }
      if(currentSlide == 0) {
        slider.find('.sw-slide:nth-of-type('+ ($s.length - 1)  +')').addClass("active");
      }
      slider.find('.sw-slide:nth-of-type('+ (currentSlide + 1) +')').addClass("active");
      afterSlideFn(currentSlide);
      if(currentSlide == 0) {
